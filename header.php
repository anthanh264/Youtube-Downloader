...
<meta name="keywords" content="video, youtube, download" />
<meta name="description" content="Tải video từ YouTube về máy tính, điện thoại, máy tính bảng, mobile miễn phí. Download tất cả định dạng: Mp4, WebM, flv, 3GP, HD video, convert âm thanh MP3 từ YouTube." />
	...
	<div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
		...
		<div id="custom-search-input">
			...
			<div class="input-group col-md-12">
				...
				<input type="text" name="q"  class="search-query form-control" id="youtube" placeholder="Tìm Kiếm video..."><span class="input-group-btn"><button class="btn btn-danger" type="submit" style="z-index:4"><span class="fa d-inline fa-search"></span></button></span>
				</div>
			</form>
		<script >
