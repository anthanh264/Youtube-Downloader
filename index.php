...
<div class="topmenu w-100 px-2">  
    <div class="swiper-container">  
        <div class="swiper-wrapper">
            <?php
            echo '<span class="swiper-slide"><a href="./" class="text-primary">Trang chủ</a></span>';
...
<div class="container d-lg-none d-md-none p-0">
 ...
 ?>
  ...
  <div class="container py-2">
    ...
    "> 
   <h3 class="pt-5 pb-2 text-white">Xin chào！</h3>
    <form>
  <div class="form-group" >
      <input type="text" name="v" style="width: 70%;height: 50px;border: none;box-sizing: border-box;padding: 14px 18px;" placeholder="Vui lòng nhập một ID video hoặc liên kết Youtube"  autocomplete="off" /><button type="submit"  style="width: 18%;border: none;height: 50px;background-color: #e62117;color: #fff;font-size: 18px;display: inline-block;" ><i class="fa fa-youtube-play fa-lg pr-1"></i>Search</button>
  </div>
    </form>
    <p class="text-white m-0">Hệ thống tải video từ YouTube:</p>
    <p class="text-white m-0">Chúng tôi cho phép bạn tải trực tiếp video từ YouTube</p>
    <p class="text-white m-0">Toàn bộ nội dung đều MIỄN PHÍ</p>
    <p class="text-white m-0">Chúng tôi không chịu trách nhiệm bất kì nội dung nào trên website!</p>
    </div>
    ...
    <div class="col-4 text-right sm-p">
      <a href="./content.php?cont=trending" title="Xem thêm" target="_blank" class="icontext h6 pl-1 ">Xem thêm <i class="fa d-inline fa-lg fa-angle-double-right"></i></a>
    </div>
  </div>
