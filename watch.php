    ...
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8 leffix">
            ...
            <div class="vinfo fsize2 clearfix">
                ...
                <span class="pull-left ">Danh mục <a href="./content.php?cont=category&sortid=<?php echo $videodata['items']['0']['snippet']['categoryId']?>" class="pl-2 d-inline"  target="_blank"><?php echo categorieslist($videodata['items']['0']['snippet']['categoryId'])?></a>
                </span>
                ...
                <div id="accdiv" class="px-3 py-2 mt-2 fsize2 clearfix ">
                    ...
                    <a href="./channel.php?channelid=<?php echo $videodata['items']['0']['snippet']['channelId'] ?>" class="btn btn-sm btn-c pull-right fsize2 my-1"><p class="text-primary m-0 px-2">Xem Kênh</p></a>
