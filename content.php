...
case 'DMCA':
	...
	break;
case 'video':
    $headtitle='Download Video '.'-'.SITE_NAME;
	break;
case 'api':
         ...
         <div class="col-md-9 relatedlist">
            ...
            switch ($cont) {
		        ...
		        echo '<div id="videocont"></div>
            		...
            		echo '<option '. $relevance .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&ptk='.$ptk.'">Video Nổi Bật</option>';
            		echo '<option ' . $date1 .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=date&ptk='.$ptk.'">Video Mới Nhất</option>';
            		echo '<option ' . $viewCount .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=viewCount&ptk='.$ptk.'">Xem nhiều</option>';
            		echo '</select></div></div>';
